...
byte rowPins[ROWS] = {A1,8,7,6};//row pinouts of keypad
...
//byte blockcontent[16] = {"EVIL0935050"};//an array with 16 bytes to be written into one of the 64 card blocks is defined
